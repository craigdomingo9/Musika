...
function ProfileIcon({active}: Props) {
  ...
  return (
    <div className='text-center flex w-full justify-center'>
        {!profile?.profile_picture && !businessCode &&(
            active ? (
        ...
        {businessCode && (
            !active ? (<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
