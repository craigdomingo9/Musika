...
function InventoryProductItemDeleteButton({product}: Props) {
  ...
  return (
    <div className='grid overflow-clip'>
        <AlertDialog>
            <AlertDialogTrigger className="flex justify-center place-items-center w-full max-w-12 sm:max-w-16 md:max-w-20 lg:max-w-24 rounded-none bg-red-400 text-white rounded-br-lg">
