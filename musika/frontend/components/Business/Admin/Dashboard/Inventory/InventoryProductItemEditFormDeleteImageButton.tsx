...
function InventoryProductItemEditFormDeleteImageButton({product,index}: Props) {
  ...
  return (
    <div className='grid'>
        <AlertDialog>
            <AlertDialogTrigger className='mx-auto w-36 grid place-items-center'>
                <div className="mx-auto grid place-items-center border w-full h-8 rounded-none text-red-600">
