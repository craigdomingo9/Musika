...
type Props = {
    product: Product; // Ensure Product type is defined
};
...
function InventoryProductItem({ product }: Props) {
    ...
    return (
        <div className="w-full flex flex-col justify-center min-h-48 max-w-64 lg:max-w-72 rounded-xl border">
            <div className="grid place-items-center min-h-48 max-h-64 lg:max-h-72">
            ...
            <div className="px-2 mb-4">
                ...
                <div className="flex justify-between">
                    ...
                    {product.on_sale && <p>Sale: ${product.sale_price}</p>}
                </div>
