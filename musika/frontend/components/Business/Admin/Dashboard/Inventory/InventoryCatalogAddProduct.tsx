...
function InventoryCatalogAddProduct({ catalog, category }: Props) {
    ...
    const editQuantity = (action: string) => {
        ...
        form.setValue("inventory_quantity", newQuantity);
    };
                        ...
                        <Tabs defaultValue="details" className="min-h-full">
                            ...
                            <TabsContent value="details">
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="mb-5">
                                            ...
                                            <FormControl>
                                                <Input className="text-sm" placeholder="eg. Water Bottle." {...field} />
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    )}
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="mb-5">
                                            ...
                                            <FormControl>
                                                <Textarea className="text-sm" placeholder="Product Description." {...field} />
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    )}
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="mb-5">
                                            ...
                                            <FormControl>
                                                <Input className="text-sm" placeholder="eg. $20" {...field} />
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    )}
                                ...
                                <FormField
                                    control={form.control}
                                    name="sale_price"
                                    disabled={!form.getValues("on_sale")}
                                    render={({ field }) => (
                                        <FormItem className="mb-5">
                                            <FormLabel>Sale Price</FormLabel>
                                            <FormControl>
                                                <Input className="text-sm" placeholder="eg. $10" {...field} />
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    )}
                                            ...
                                            <FormControl>
                                                <div className="flex">
                                                    <Button 
                                                        ...
                                                        className="w-10 bg-color mx-2" 
                                                        onClick={() => editQuantity("decrement")}
                                                    >
                                                        -
                                                    </Button>
                                                    <Input 
                                                        type="number" 
                                                        className="text-sm w-10 text-center sm:w-16" 
                                                        {...field} 
                                                    />
                                                    <Button 
                                                        type="button" // Ensure this button does not submit the form
                                                        className="w-10 bg-color mx-2" 
                                                        onClick={() => editQuantity("increment")}
                                                    >
                                                        +
                                                    </Button>
                                                </div>
